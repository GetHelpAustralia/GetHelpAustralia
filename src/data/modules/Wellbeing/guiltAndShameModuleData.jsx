    ...
    description: {
      ...
      content: (
        <>
          ...
          <p>
            Guilt and shame are often talked about as the same emotions but
            there are some key differences.
          </p>
          <ul className="content-list">
            <li>
              Guilt is the acknowledgement that we have done something wrong,
              but that behaviour does not define who we are as a person. Someone
              experiencing guilt is able to recognise their pleasant qualities
              and still see themselves in a good light.
            </li>
            <br></br>
            <li>
              Shame is the belief that we have done something wrong and that
              makes us a bad person. Someone experiencing shame may not be able
              to identify their pleasant qualities or see themselves in a good
              light.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            time. If someone sees themselves as a bad person, they might not see
            a way out of their situation or feel unable to change their
            behaviour. This can make them more likely to re-offend and
            potentially more likely to harm themselves.
          </p>
          <br />
        </>
      ),
      ...
      content: (
        <>
          ...
          <p>
            ...
            recognise if they are experiencing shame, and some might apply to
            you. Try to identify other signs and add them to the table.
          </p>
          <br></br>
          ...
          <p>
            Reflecting on what we have covered so far, ask yourself: which do
            you think you are experiencing – guilt or shame?
          </p>
          <p>
            We strongly encourage the people we work with to try to move away
            from shame. Sometimes people are reluctant to do this, believing
            that they should feel bad because of what they have done. We are not
            excusing offending or suggesting people should not feel regret or
            guilt. But shame is not helpful. It makes it more difficult for you
            to move forwards – away from the offending behaviour – and towards
            making a valuable contribution to your family, friends and society.
          </p>
          <br />
        </>
      ),
    ...
    description: {
      ...
      content: (
        <>
          ...
          <p>
            Here are some techniques you can use to manage your feelings of
            shame.
          </p>
          <h5 className="secondary-color">
          ...
          <p>
            ...
            Other people are often good at challenging you or pointing out
            things that you do well. They will see the whole person and not just
            the behaviour. By sharing how you feel, the emotions can become
            easier to manage. If you need help with talking about your thoughts
            and feelings, visit our{" "}
            <Link to="/recognising-and-dealing-with-feelings">
              <b>recognising and dealing with feelings</b>
            </Link>{" "}
            module.
          ...
          <ul className="content-list">
            <li>
              regular <b>exercise</b> provides an emotional lift and an outlet
          ...
          <p>
            What you say to yourself in your mind is called self-talk. It can
            have a really great impact on your self-esteem and confidence.
          </p>
          <p>
          ...
          <p>
            ...
            remind yourself of the good things about yourself and your life.
            Make a list of things you like about yourself, things you are good
            at, things you have achieved, and things other people like about
            you. It can be useful to carry the list around with you and look at
            it when you feel shame. Keep adding to the list and keep reminding
            yourself of the positives.
          </p>
          <p>
    ...
    description: {
      ...
      render: ({ responses, onQuestionChange }) => (
        <>
          ...
          <ReflectionQuestion
            id="recognise_own_feelings"
            value={responses.recognise_own_feelings}
            onChange={onQuestionChange}
          >
            I can now recognise my own feelings of guilt/shame.
          </ReflectionQuestion>
          <ReflectionQuestion
            id="understanding_ways_to_overcome"
            value={responses.understanding_ways_to_overcome}
            onChange={onQuestionChange}
          >
          ...
          <ReflectionQuestion
            id="deal_with_feelings"
            value={responses.deal_with_feelings}
            onChange={onQuestionChange}
          >
            I now have strategies to deal with feelings of guilt/shame.
          </ReflectionQuestion>
        </>
      ),
    },
