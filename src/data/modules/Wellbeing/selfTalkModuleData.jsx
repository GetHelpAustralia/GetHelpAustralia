      ...
      content: (
        <>
          ...
          <p>
            ...
            have a really great impact on your self-esteem and confidence. How
            you talk to yourself in your mind affects:
          </p>
          ...
          <p>
            ...
            Was it critical? Or was it kind and helpful? How did you feel after
            you engaged in this inner discussion?
          </p>
          <p>
            Your thoughts are the source of your emotions and mood. The
            conversations you have with yourself can be destructive or
            beneficial. They influence how you feel about yourself and how you
            respond to events in your life.
          </p>
          ...
          <p>
            ...
            be helpful and keep us motivated toward goals—like when it reminds
            us that what we’re about to eat isn’t healthy or what we’re about to
            do may not be wise. However, this voice can often be more harmful
            than helpful.
          </p>
          <p>
          ...
          <p>
            ...
            well as greater feelings of helplessness and sometimes depression.
            For some people it also contributes to their sexual offending as
            they use it to justify harmful behaviours, so it’s definitely
            something to fix.
          </p>
          <br />
          <img
    ...
    description: {
      ...
      content: (
        <>
          ...
          <p>
            You need to be aware of the nature of your self-talk and be
            determined to shift any negative thinking to positive. This is not
            always easy as even though you will have a number of positive
            qualities you may struggle to recognise them and find it hard to
          ...
          <p>
            ...
            situation to focus on, rather than the negative. This is something
            we often do after a bereavement for example, remembering the
            positive life someone had rather than the loss.
          </p>
          <p>
            <span className="secondary-color">4. </span>
            <b>Use pleasant language.</b> If you constantly say “I can’t” you
            will convince yourself that it’s true. Replace critical words with
            complementary ones.
          </p>
          <p>
          ...
          <p>
            ...
            determination to change negative thinking and adopt a more
            optimistic approach.
          </p>
          <p>
            <span className="secondary-color">7. </span>
            <b>Catch it, Check it, change it </b>– the more you start spotting
            and changing your negative self talk to complimentary the better you
            will get!
          </p>
          <hr />
          ...
          <p>
            ...
            identify and rehearse some complimentary self-talk statements that
            you can employ before during and after the situation.
          </p>
          ...
          <br></br>
          <p>
            This planning can be used in any situation. Think of something you
            are doing this week that you are worried or nervous about and think
            of three positive self-talk statements you can say to yourself to
            help prepare yourself positively.
          </p>
          <hr />
          <br></br>
          ...
          <p>
            ...
            sexual behaviour. By increasing your awareness of this process and
            the negative effects of offending for yourself and others, you
            increase your ability and motivation to avoid offending.
          </p>
          <img
            src={pictureSix}
    ...
    description: {
      ...
      render: ({ responses, onQuestionChange }) => (
        <>
          ...
          <p>
            Keep a diary for a week of any unpleasant things you say to
            yourself. After a week look back and see what sort of messages you
            give yourself.
          </p>
          ...
          <ReflectionQuestion
            id="understanding_self_talk"
            value={responses.understanding_self_talk}
          ...
          <ReflectionQuestion
            id="strategies_self_talk"
            value={responses.strategies_self_talk}
            onChange={onQuestionChange}
          >
