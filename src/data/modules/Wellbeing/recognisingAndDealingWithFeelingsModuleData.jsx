    ...
    description: {
      ...
      render: ({ onDataChange }) => (
        <>
          ...
          <br></br>
          <p>
            Emotions are the sensations in the body as a result of something
            that happens to us. Feelings are generated from our thoughts about
            those emotions and we then choose a response. People often find it
            very hard to recognise their emotions and feelings. The exercises in
            this module aim to help you get more in tune with your body so that
            you notice how it is responding in different situations.{" "}
          </p>
          <br />
          ...
          <p>
            Some of the common reasons identified by individuals who have
            accessed sexual images of children include dealing with unpleasant
            emotions such as stress, loneliness, frustration, depression and
            anxiety.
          </p>
          <p>
          ...
          <p>
            ...
            manage your emotions and deal with your problems in a healthier way
            is likely to reduce the probability of engaging in problematic
            sexual behaviour and harming children.
          </p>
        </>
      ),
    },
        ...
        <>
          ...
          <p>
            <em>
              ...
              thoughts will then heighten those emotions and increase the
          ...
          <p>
            This includes how you feel about yourself (your self-esteem); how
            you feel about your situation and your feelings towards other
            people. For example an individual who feels powerless may lose
            motivation and believe that there is no point in trying, as he will
            not succeed. He may withdraw and isolate himself. Similarly an
            individual who ruminates on problems and focuses on negatives is
            unlikely to see the positives in other people or situations and this
            can increase his feelings of isolation.
          </p>
          <hr />
          <h5 className="secondary-color">
          ...
          <p>
            If you are unsure of pleasant and unpleasant thinking (otherwise
            known as self-talk) then please work through our{" "}
            <Link to="/self-talk">
          ...
          <p>
            ...
            Unpleasant thinking tends to manifest itself in patterns of
            behaviour which are characterized by stress, worry, anxiety and
            frustration.
          </p>
          ...
          <p>
            Situation: Saying hello to a work colleague who doesn't respond.
          </p>
          ...
          <p>
            ...
            think of other reasons. You may notice the feelings are more
            pleasant.
          </p>
          <p>
            Now think about your illegal online behaviour? Can you identify any
            feelings and unpleasant thoughts that might contribute to the
            decision to view sexual images of children.
          </p>
          <br />
          ...
          <ul className="content-list">
            ...
            <li>
              <b>Negative focus</b> – always focusing on the unpleasant aspects
              of a situation rather than looking at the positives e.g. instead
              of being happy about passing an exam, being upset that you did not
              get a higher grade.
            </li>
          </ul>
          <br />
    ...
    description: {
      ...
      content: (
        <>
          ...
          <p>
            The following will help you deal with some common unpleasant
            emotions but can also be applied to others.
          </p>
          <br />
          ...
          <p>
            ...
            such as checking that we have turned off the oven but it can become
            a significant problem.
          </p>
          <br />
          <p>
            If you answer “yes” to the following questions, then worrying might
          ...
          <ul className="content-list">
            ...
            <li>
              Do you feel that your worrying is “out of control” or that once
              you start you just can’t stop?
            </li>
            <li>
              Do you feel worrying has affected your health (e.g., stomach
              aches, headaches, or diarrhoea)?
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            the more anxious you become! It becomes a vicious circle, this is
            why it is really important to learn how to manage your emotions in a
            healthy way.
          </p>
          <br />
          ...
          <p>
            Notice when you are worrying or feeling anxious. If you recognise
            the signs of anxiety mentioned above, or you notice you are thinking
            thoughts like those outlined, take notice of them- don’t ignore
            them.
          </p>
          <p>
            <b>Step 2 - "Stop"!</b>
          ...
          <p>
            ...
            relaxing and/or enjoyable e.g. reading, watching TV, cooking,
            calling a friend, doing a hobby, or playing a sport.
          </p>
          <p>
          ...
          <p>
            ...
            more than ten to fifteen minutes is needed. This is your “worry
            time” when you can focus on what it is that is causing you to worry
            and try to generate some solutions. If you find yourself worrying at
            a time when you have other things to do (such as when you are at
            work or at bedtime, or while you are trying to concentrate on
            something else), tell yourself to stop and put off the worries until
            later. This is not about avoiding problems but is about putting what
            is worrying you into perspective and dealing with it when you are
          ...
          <p>
            If you find yourself worrying about the same thing over and over
            (for example, “I’ll start my new job and no one will like me”) then
            write down the opposite, “pleasant” thought (for example, “People
            will like me- I’m a nice person”). Every time you notice yourself
            worrying about this thought challenge your thinking. Use the
            ‘questioning yourself’ strategy identified earlier in the module and
            counter your worry with the pleasant thought. You could even write
            the pleasant thought or statement down on a small card and carry it
            with you to remind yourself of it.
          </p>
          <p>
          ...
          <p>
            ...
            problem shared is a problem halved! If you can tell someone you
            trust what your problem is, they can often help you with solving or
            coping with it. You can find more about{" "}
          ...
          <p>
            People express anger in different ways; it can take many forms.
            Below are some of the ways that anger can be experienced.
          </p>
          <p>
          ...
          <p>
            ...
            admitting they are angry and avoid expressing angry feelings. They
            try to convince themselves that they are not angry. This can be
          ...
          <p>
            ...
            angry or when other people around them become angry. Consequently
            they do not learn to manage their own or other people’s anger.
          </p>
          <p>
            <b>Bottlers</b>
          </p>
          <p>
            ...
            thing. Whatever the reason, bottling up angry feelings can feel like
            a pressure cooker or a champagne bottle in which the pressure is
          ...
          <p>
            Some people shout and scream and blow off steam when they feel
            angry. They lash out physically and/or verbally. In the short term
            this can produce an immediate release but such outbursts of anger
            can have negative long term consequences for themselves and their
          ...
          <p>
            ...
            energy and focus to respond to the threat. Our bodies are designed
            to deal with short periods of threat. However in the modern day we
            are exposed to longer term threats or stressors which results in our
            body releasing these hormones for longer periods of time. This can
            be really harmful and effect our sleep, concentration, memory and
            drive us to look for short term ‘fixes’ such as caffeine, sugar,
          ...
          <ol>
            <li>
              <b>Reduce the amount of stress in your life,</b> for example if
              your job is highly stressful then consider if there are
              alternatives.
            </li>
            <li>
              <b>Change how you manage stress,</b> for example can you delegate
              some tasks or learn that good enough is ok rather than striving
              for perfection.
            </li>
            <li>
              <b>Look after your physical health,</b> for example eating
              healthily and doing exercise even if you don’t feel like it.
            </li>
            <li>
            ...
            <li>
              <b>Be sociable,</b> even if you feel like everything is getting
              too stressful and too much for you, one of the best things you can
              do is to meet up with your family and friends – for example,
              meeting up for a coffee or going for a walk. Friends and family
              will be able to provide you a distraction from your stress and
              they can help you to see the situation from a different point of
              view.
            </li>
          </ol>
          <p>
    ...
    description: {
      ...
      render: ({ responses, onQuestionChange }) => (
        <>
          ...
          <p>
            Think about... what shows me something is wrong, and what can I do
          ...
          <ReflectionQuestion
            ...
            value={responses.understanding_emotions}
          ...
          <ReflectionQuestion
            id="strategies_difficult_emotions"
            value={responses.strategies_difficult_emotions}
            onChange={onQuestionChange}
          >
