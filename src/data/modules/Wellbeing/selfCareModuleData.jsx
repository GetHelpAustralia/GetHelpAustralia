    ...
    description: {
      ...
      content: (
        <>
          ...
          <p>
            Self-care is important in helping you move away from risky and
            illegal behaviour. When people feel happy and content, they are far
    ...
    description: {
      ...
      render: ({ onDataChange }) => (
        <>
          <br></br>
          <p>
            Please complete the following wellbeing assessment that will ask
            about your physical, social, mental, spiritual and emotional
            self-care.
          </p>
          <br />
    ...
    description: {
      ...
      content: (
        <>
          ...
          <p>
            It might help you to complete a self-care plan. There isn’t a one
            size fits all for this and will need to be tailored to meet your own
            needs. Think about what is going on in your life and which areas
            would benefit from attention and self-care – the scores that you
            gave for each of the sections above will help you.
          </p>
          <p>
            Use the table below to set some goals to improve your self-care. You
            don’t need to have goals in all sections, particularly if the
      ...
      content: (
        <>
          ...
          <p>
            ...
            and how to do them. Some strategies will be more effective than
            others for each person, and it is about finding out which works for
            you.
          </p>
          <br />
              ...
              <AccordionDetails>
                <div>
                  ...
                  <p>
                    ...
                    flat on the ground, roughly hip-width apart. If sitting,
                    arms should be placed on the chair arms. The breath should
                    flow as deep down into the belly as is comfortable, without
                    forcing it.
                  </p>
                  <ul className="content-list">
                    <li>
                    ...
                    <li>
                      Breathe in gently and regularly. Some people find it
                      helpful to count steadily from 1 to 5. You may not be able
                      to reach 5 at first.
                    </li>
                    <li>
                  ...
                  <ul className="content-list">
                    ...
                    <li>
                      Take a deep breath in through your nose, and let your
                      belly push your hand out. Your chest should not move.
                    </li>
                    <li>
                  ...
                  <p>
                    ...
                    helps to develop the full use of the lungs and to focus on
                    the rhythm of breathing. This technique can be done in any
                    position. However, whilst learning, it is best to lie on
                    your back with your knees bent.
                  </p>
                  <ul className="content-list">
                    <li>
                      Put your left hand on your belly and your right hand on
                      your chest. Notice how your hands move as you breathe in
                      and out.
                    </li>
                    <li>
                      Practice filling your lower lungs by breathing so that
                      your "belly" (left) hand goes up when you inhale and your
                      "chest" (right) hand remains still. Always breathe in
                      through your nose and breathe out through your mouth.
                      Repeat 8 to 10 times.
                    </li>
                    <li>
                      When you have filled and emptied your lower lungs 8 to 10
                      times, add this second step to your breathing: inhale
                      first into your lower lungs as before, and then continue
                      inhaling into your upper chest. Breathe slowly and
                      regularly. As you do so, your right hand will rise and
            ...
            <Accordion>
              ...
              <AccordionDetails>
                ...
                <p>
                  ...
                  techniques can be particularly helpful when feeling worried
                  and anxious about the past or what could happen in the future.
                  They can help to redirect our thoughts away from traumatic
                  memories, flashbacks, and distressing feelings and bring us
                  back to the here and now. There are many different types of
                  grounding techniques. They aren’t always easy and it can take
                  practice before they begin to work well for you, so don’t give
                  up if they don’t seem to help immediately. It is important to
                  use the techniques as early as you can when you begin to
                  experience distress – although they are a useful technique to
                  practice generally, whether feeling distressed or not.
                </p>
                <h5 className="secondary-color">
                  Grounding exercise 1: 5-4-3-2-1 method
                </h5>
                <p>
                  Acknowledge five things you can see around you; four things
                  you can touch around you; three things you can hear around
                  you; two things you can smell and one thing you can taste.
                </p>
                <p>
                  The aim of this technique is to focus on the world around you
                  so that you are less focused on what is making you feel
                  anxious, worried, or distressed.
                </p>
                <h5 className="secondary-color">
                ...
                <p>
                  ...
                  category. Alternatively, try reciting the alphabet backwards
                  or practicing times tables.
                </p>
                <p>
                  Again, the purpose of these exercises is to focus your
                  attention on something other than whatever is making you feel
                  ungrounded.
                </p>
                <h5 className="secondary-color">
                ...
                <p>
                  ...
                  identify how each body part feels and then move on to the
                  next. Close your eyes if that helps you to focus on the
                  exercise.
                </p>
                <p>
                  Begin by taking some deep breaths and then bring your
                  awareness to where your body makes contact with the floor or
                  chair. Begin by scanning your left foot for any sensations,
                  moving up your calf and thigh. Then move to the right leg and
                  follow the same order. It is ok if you don’t feel anything,
                  just observe that and move on. Then focus on your stomach,
                  feeling it rise and fall with your breath. Next focus on your
                  left hand and arm. Bring curiosity to your scanning,
                  continuing to notice any sensations. Continue with your right
                  hand and work up the arm. Move to your chest, scanning upwards
                  to your neck, face, jaw, and throat. Pay attention to any
                  sensations in your head, ears, and the back of your neck.
                  Finally, think of your body as a whole, noticing how they all
                  connect. Stay alert to any sensations that you experience and
            ...
            <Accordion>
              ...
              <AccordionDetails>
                ...
                <p>
                  ...
                  lives, but also when we need to give ourselves some self-care
                  to maintain our emotional wellbeing. Some people find it
                  helpful for mindfulness exercises to be built into their
                  everyday routine, even if only for a few minutes.
                </p>
                <h5 className="secondary-color">
                ...
                <ul className="content-list">
                  ...
                  <li>
                    ...
                    its rhythm, and how each inhale and exhale of breath feels
                    and makes your body respond.
                  </li>
                  <li>
      ...
      content: (
        <>
          ...
          <p>
            ...
            techniques, think about what you can add to your self-care plan.
            Using the original template, consider what other techniques and
            resources will be helpful for you, and add these to the bottom two
            rows of your plan.
          </p>
          <br></br>
          <table className="table table-bordered">
        ...
        <>
          <div>
            ...
            <p>
              ...
              sexual preoccupation and problematic pornography use say that
              these difficulties can be especially tough at night, often
            ...
            <ul className="content-list">
              <li>
                Stick to a&nbsp;regular pattern by aiming to wake up and go to
                bed at the same times every day of the week. Some people choose
                to stay up and wake much later during the weekends, which tends
                to disrupt the sleep pattern into the following week.
              </li>
              <li>
              ...
              <li>
                Avoid alcohol, cigarettes, caffeine and food consumption too
                close to bedtime. Tea, coffee, colas drinks and chocolate with
                caffeine can disrupt sleep if consumed in the evening.
              </li>
              ...
              <li>
                Use your bed for sleep, rather than as a place to read, watch
                TV, listen to the radio, or use your phone, laptop or tablet.
                That way, the bed becomes associated with sleep rather than with
                these other activities.
              </li>
              <li>
                Think about whether your bedroom might be making it harder for
                you to sleep, for example, temperature, uncomfortable bed,
                inadequate curtains or blinds.
              </li>
              <li>
                Try to&nbsp;avoid mentally engaging in activities close to
                bedtime.&nbsp;It can take some time for the mind to switch off
                and if you are feeling alert you are less likely to fall asleep.
              </li>
            </ul>
            <p>
              It might take some time before any changes you make to your sleep
              routines take effect. If you regularly find you are having
      ...
      render: ({ responses, onQuestionChange }) => (
        <>
          ...
          <p>
            ...
            your risky online behaviour and moving away from it, towards a
            better future. Investing time in self-care will enable you to feel
            more resilient when undertaking the upcoming modules. We would
            encourage you to factor in self-care after each session of working
            through these self-help modules.
          </p>
          <br></br>
          <p>
          ...
          <ReflectionQuestion
            id="understanding_self_care"
            value={responses.understanding_self_care}
