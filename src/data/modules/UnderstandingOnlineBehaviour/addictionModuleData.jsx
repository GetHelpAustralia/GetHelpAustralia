      ...
      content: (
        <>
          <div className="tab-main-content">
            ...
            <p>
              Typically an individual becomes dependent on something to reduce
              the pain of certain emotions. Usually they get pleasure the first
              time they try it and then they return to the behaviour to get the
              same feeling of pleasure. Continual usage leads to a reliance on
              the behaviour to feel normal which ultimately leads to
            ...
            <ul className="content-list">
              <li>
                Do you find yourself doing it more often and for longer periods
                of time than you originally intended?
              </li>
              <li>
              ...
              <li>
                Do you feel anxious or uncomfortable when you can't do it or
                even when you think about not doing it?
              </li>
              <li>
                Has doing it negatively impacted your life and your
                relationships?
              </li>
              <li>
                Do you often tell yourself you'll stop, only to end up
                continuing the same behavior?
              </li>
            </ul>
            <p>
              If several of these questions relate to you, then this module may
              be helpful for you.
            </p>
            <hr />
            <br></br>
    ...
    description: {
      ...
      content: (
        <div className="tab-main-content">
          ...
          <p>
            Addiction may be an element that helps you understand your pathway
            to offending, and what is important to put in place to ensure you do
            not offend again, but it does not excuse the behaviour. The more you
          ...
          <p>
            So if you have recognised an addictive element to your offending,
            you need to understand more about it. Why do you think your use of
            the internet became addictive? What emotions were you
            avoiding/covering up?
          </p>
          <p>
            You will need to look at reasons or motivations behind your
            addiction. You have already started looking at motivations for your
            offending and triggers to your behaviour. Think about the following
            questions:
          </p>
          <ol>
            <li>
            ...
            <li>
              Do I always use quick fixes (sex, drugs, alcohol, gambling) to
              feel better?
            </li>
            <li>
          ...
          <p>
            It is quite common that people replace one addiction with another.
            Be aware of this and if you have found that you have had other
            addictions in the past or other current addictions you may need to
            get specific support to address these. There are a number of
            organisations that may be helpful for specific addictions, such
            as&nbsp;
            <a
      ...
      content: (
        <>
          <div className="tab-main-content">
            ...
            <ul className="content-list">
              <li>
                Challenging your thoughts that make it feel like the behaviour
                is okay.
              </li>
              <li>
              ...
              <li>
                ...
                <br />
                <li>
                  Thought stopping – physical prompt to stop fantasy e.g.
                  elastic band around your wrist.
                </li>
              </li>
              <li>
              ...
              <li>
                Relaxation techniques – use appropriate guided visualisation
                that works for you – this should be something that has been
            ...
            <p>
              This can also be used to help you recognise patterns when your
              urge to engage in illegal online sexual behaviour is strongest or
              what moods are linked to the urges. This awareness will help with
              your relapse prevention and risk management.
            </p>
            <br></br>
          </div>
        </>
        ...
        <>
          <div className="tab-main-content">
            ...
            <ul className="content-list">
              ...
              <li>
                What is the most effective way to manage your urges and
                triggers?
              </li>
              <li>
          ...
          <ReflectionQuestion
            id="understanding_compulsion"
            value={responses.understanding_compulsion}
            onChange={onQuestionChange}
          >
            I now have a better understanding of the difference between
            addiction and compulsion.
          </ReflectionQuestion>
          <ReflectionQuestion
            id="understanding_addiction"
            value={responses.understanding_addiction}
            onChange={onQuestionChange}
          >
          ...
          <ReflectionQuestion
            id="addressing_addiction"
            value={responses.addressing_addiction}
            onChange={onQuestionChange}
          >
