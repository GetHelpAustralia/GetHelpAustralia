    ...
    description: {
      ...
      content: (
        <div className="tab-main-content">
          ...
          <p>
            During the court appearance, you will have the opportunity to enter
            a plea of guilty or not guilty. If you plead not guilty, a trial
            date will be set. If you enter a guilty plea, a sentencing date will
            be scheduled.
          </p>
          <p>
            The various sentencing options are detailed below. However,
            predicting the specific outcome of sentencing can be challenging,
            and is therefore important to seek legal advice in all cases.
          </p>
          <br />
          <p>
            <img
          ...
          <p>
            ...
            court can issue. Where an offence is of a sexual nature, committed
            in relation to a child, the courts are more likely to order a term
            of imprisonment.
          </p>
          ...
          <p>
            A suspended sentence is a custodial sentence wherein the individual
            is not required to go to prison as long as they refrain from
            committing further offences and comply with imposed requirements.
            Failure to comply or committing additional offences can lead to the
            activation of the suspended sentence, requiring the individual to
            serve the suspended period in custody. A suspended sentence can
            include specific conditions, such as offence-related work.
          </p>
          ...
          <p>
            Anyone convicted of a prescribed sexual offence is put on the
            National Child Offender System (NCOS).This national scheme requires
            child sex offenders, and other defined categories of serious
            offenders against children, to keep police informed of their
            whereabouts and other personal details for a period of time after
      ...
      content: (
        <div className="tab-main-content">
          ...
          <p>
            ...
            and sometimes restrictions may be re-evaluated, especially during
          ...
          <p>
            When looking for a new job, certain roles may not be suitable for
            you, particularly those involving children or vulnerable adults.
            When applying for specific jobs, you’ll likely be asked to declare
            any convictions. Such convictions might be revealed if your employer
    ...
    description: {
      ...
      content: (
        <div className="tab-main-content">
          ...
          <p>
            There are steps you can take to mitigate the impact of media
            coverage.
          </p>
          ...
          <ul>
            <li>
              ...
              friends if you’re worried they'll discover the situation through
              the media.
            </li>
            <li>
              - For people under investigation and their families, we recommend
              temporarily deactivating social media accounts or adjusting
              privacy settings during sentencing hearings to minimise exposure
              to media coverage.
            </li>
            <li>
          ...
          <p>
            ...
            supported who faced media coverage and how they managed the
            situation and how they coped.
          </p>
          <br></br>
        </div>
      ),
    ...
    description: {
      ...
      content: (
        <div className="tab-main-content">
          ...
          <p>
            Understanding how other people might feel can help you anticipate
            how they might react. Sexual thoughts or behaviours involving
            children are unexpected and naturally raise numerous questions. For
            instance, your partner might wonder about your motivations, the
            consequences for you, how it impacts them, the well-being of any
            children you have, and the implications for the future. Think about
            your own emotions of fear and distress. Other people are likely to
            share these emotions and will also be shocked by finding out about
            your behaviour through you or the police.
          </p>
          <p>
            People’s reactions might not align with your predictions. Shock
            could stop people being able to think of questions, while others
            might have many questions or repeatedly ask the same thing. Tears,
            anger, and even self-blame are possible responses.
          </p>
          <p>
          ...
          <p>
            ...
            other peoples’ emotions, it’s important to ask questions and
            genuinely listen. This can be tough, especially if they express
            negativity or intense anger due to your behaviour.
          </p>
          ...
          <ul className="content-list">
            ...
            <li>
              Verbal responses: offering relatable comments, sounds, and
              relevant questions displays active involvement.
            </li>
            <li>
      ...
      content: (
        <div className="tab-main-content">
          ...
          <p>
            ...
            without sharing graphic details. This helps them understand and
            decide how they want to proceed in the relationship. It’s better for
            them to hear about this from you than from the police or other
            people.
          </p>
          <ul className="content-list">
            <li>
            ...
            <li>
              ...
              possibly leading to mental health challenges. Offer support, and
              if needed, suggest contacting professionals.
            </li>
            <li>
            ...
            <li>
              Help them understand sexual offending: help your partner
              understand the complexity of the situation by offering information
              about sexual offending. Refer them to reliable resources or
              helplines.
            </li>
          </ul>
          <h4 className="secondary-color">Talking to children</h4>
          <p>
            Telling children about offending can be tough for parents. Think
            about these points when speaking to them.
          </p>
          <ul className="content-list">
            <li>
              Address changes clearly: if significant changes occur, children
              might speculate and make assumptions. Provide a clear explanation
            ...
            <li>
              ...
              even adults struggle to understand. Assure them that their parent
              is seeking help.
            </li>
            <li>
          ...
          <ul className="content-list">
            ...
            <li>
              Know your record: understand your criminal record’s content and
              how it impacts job applications.
            </li>
            <li>
              Check employer policies: understand your potential employer’s
              policy on hiring individuals with convictions.
            </li>
            <li>
              Honesty in interviews: you don’t always need to disclose details
              on application forms. Instead, confirm you have a conviction and
              are happy to discuss at interview where you can explain in more
              detail and the changes you have made in your life.
            </li>
            <li>
            ...
            <li>
              Positivity and honesty: stay confident, honest, and true to
              yourself while discussing the situation.
            </li>
          </ul>
          ...
          <ul className="content-list">
            ...
            <li>
              Know your limits: share as much as you’re comfortable with, based
    ...
    description: {
      ...
      render: ({ responses, onQuestionChange }) => (
        <>
          ...
          <ReflectionQuestion
            id="understanding_criminal_justice"
            value={responses.understanding_criminal_justice}
            onChange={onQuestionChange}
          >
            I now have a better understanding of the criminal justice
            consequences of illegal behaviour.
          </ReflectionQuestion>
          <ReflectionQuestion
            id="understanding_other_consequences"
            value={responses.understanding_other_consequences}
            onChange={onQuestionChange}
          >
          ...
          <ReflectionQuestion
            id="understanding_helpful_ways"
            value={responses.understanding_helpful_ways}
            onChange={onQuestionChange}
          >
