...
const FantasyModule = ({ showMenu }) => {
  const [responses, setResponses] = useState({
    understanding_fantasies: 3,
    fantasies_and_behaviour: 3,
  });
      ...
      try {
        const response = await fetch("/", {
          ...
          body: new URLSearchParams({
            "form-name": "fantasy-reflection-form",
  ...
  const handlePostSubmit = () => {
    ...
    navigate("/adult-pornography"); // Replace with the correct path to the next module
  };

  const processedModules = FantasyModuleData.map((module) => {
    ...
    <>
      ...
      <MainContent>
        ...
        <Module
          ...
          formName="fantasy-reflection-form"
